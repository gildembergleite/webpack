...
export default function Home() {
   return (
      <section className="bg-gray-900 flex flex-col justify-center items-center min-h-[calc(100vh-96px)]">
         <div className="py-8 px-4 mx-auto max-w-screen-xl lg:py-16">
            <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 md:p-12 mb-8">
               <a
                  href="#"
                  className="bg-blue-100 text-blue-400 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md mb-2"
               >
                  <svg
               ...
               <a
                  href="#"
                  className="inline-flex justify-center items-center py-2.5 px-5 text-base font-medium text-center text-white rounded-lg bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 focus:ring-blue-900"
               >
                  Read more
                  <svg
            ...
            <div className="grid md:grid-cols-2 gap-8">
               <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 md:p-12">
                  <a
                     href="#"
                     className="bg-green-100 text-green-400 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md mb-2"
                  >
                     <svg
                        className="w-2.5 h-2.5 mr-1.5"
                        aria-hidden="true"
               ...
               <div className="bg-gray-800 border border-gray-700 rounded-lg p-8 md:p-12">
                  <a
                     href="#"
                     className="bg-purple-100 text-purple-400 text-xs font-medium inline-flex items-center px-2.5 py-0.5 rounded-md mb-2"
                  >
                     <svg
                        className="w-2.5 h-2.5 mr-1.5"
                        aria-hidden="true"
